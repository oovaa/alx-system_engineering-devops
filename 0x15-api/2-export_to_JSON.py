...
It retrieves the tasks for a specific user and writes them to a JSON file.
The file is named after the user's ID and contains their tasks in a specific format.
"""
...
def fetch_data(employee_ID):
    ...
    json_data = {
        employee_ID: [{"task": task.get('title'), "completed": task.get(
